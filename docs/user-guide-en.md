...
| Upload or recording fails with "Internal Server Error" (installer built 2026-09-11) | Packaging defect in the first v1.3.0 installers: the speech runtime failed to load inside the installed app. Re-download the installer (rebuilt 2026-09-12); the web/PWA version was never affected |
