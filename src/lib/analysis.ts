...
export { STOPS } from "@/lib/stopwords";

// ---------------------------------------------------------------- stopwords
// Function-word lists now live in @/lib/stopwords (shared with the
// corpus-wide aggregates). The per-mille priors below approximate
// general-language frequencies for the built-in keyness reference.
